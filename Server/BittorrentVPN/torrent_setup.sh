...
sudo mv /etc/transmission-daemon/settings.json /etc/transmission-daemon/settings.json.bkup
sudo cp /synced/transmission/settings.json /etc/transmission-daemon/settings.json
